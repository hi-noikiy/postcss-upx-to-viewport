...
var ignoreNextComment = 'upx-to-viewport-ignore-next';
var ignorePrevComment = 'upx-to-viewport-ignore';

module.exports = postcss.plugin('postcss-upx-to-viewport', function (options) {
...
function error(decl, message) {
  throw decl.error(message, { plugin: 'postcss-upx-to-viewport' });
}
