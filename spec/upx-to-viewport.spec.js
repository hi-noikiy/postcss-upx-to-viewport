...
describe('upx-to-viewport', function() {
...
describe('/* upx-to-viewport-ignore */ & /* upx-to-viewport-ignore-next */', function() {
  it('should ignore right-commented', function() {
    var css = '.rule { font-size: 15px; /* simple comment */ width: 100px; /* upx-to-viewport-ignore */ height: 50px; }';
  ...
  it('should ignore right-commented in multiline-css', function() {
    var css = '.rule {\n  font-size: 15px;\n  width: 100px; /*upx-to-viewport-ignore*/\n  height: 50px;\n}';
    var expected = '.rule {\n  font-size: 4.6875vw;\n  width: 100px;\n  height: 15.625vw;\n}';
